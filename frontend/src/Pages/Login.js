...
background: linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(46,75,65,1) 0%, rgba(5,25,62,1) 100%);
...
form{
    ...
    .button{
        ...
        color: white;
        background: rgb(2,0,36);
        background: linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(52,88,151,1) 0%, rgba(67,107,93,1) 100%);
